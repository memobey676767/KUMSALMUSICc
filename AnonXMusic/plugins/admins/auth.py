...
@app.on_message(filters.command("ytver") & filters.group & ~BANNED_USERS)
@AdminActual
...
@app.on_message(filters.command("ytal") & filters.group & ~BANNED_USERS)
@AdminActual
...
@app.on_message(
    filters.command(["ytlist"]) & filters.group & ~BANNED_USERS
)
@language
