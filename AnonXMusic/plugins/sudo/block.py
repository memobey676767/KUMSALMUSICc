...
@app.on_message(filters.command(["karakullanici"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["beyazkullanici"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["kullanicilist"]) & SUDOERS)
@language
